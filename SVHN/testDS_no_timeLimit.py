...
#from madryCifarUndefWrapper import *
target_set=load(open("indices_12000_SVHN_share_robot_ds/indices_of_12000_correct_x_train.pkl","rb"))
...
dump(time_taken,open(path+"time_taken_noTIIMELIMIT_svhn_26Nov_230am.pkl","wb"))